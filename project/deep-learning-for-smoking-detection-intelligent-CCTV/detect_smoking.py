...
"""Example using TF Lite to detect smoking with the Raspberry USB webcam."""
...
def main():
  ...
  while True:
    ...
    results, flag = detect_objects(interpreter, frame_re, args.threshold)

    if (flag):
        cv2.imwrite("./record/" + str(now) + ".png", frame)
